Public Class frm_staffdelete_a173586
    ...
    Private Sub del_Click(sender As Object, e As EventArgs) Handles del.Click
        ...
        If delete_confirmation = MsgBoxResult.Yes Then
            run_sql_command("DELETE FROM TBL_STAFFS_A173586 WHERE FLD_STAFF_ID='" & current_code & "'")
            Beep()
    ...
    Private Sub frm_staffdelete_a173586_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        refresh_grid()
        get_current_code()
    End Sub
